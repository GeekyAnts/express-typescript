...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/node-server-with-typescript$1.0.0/views/index.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("You have new messages! ");

  lasso_body_tag({}, out, __component, "7");

  browser_refresh_tag({}, out, __component, "8");
...
marko_template.meta = {
    id: "/node-server-with-typescript$1.0.0/views/index.marko",
    tags: [
